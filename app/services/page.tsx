...
export default function ServicesPage() {
  ...
  return (
    <main
      className={`${sans.className} relative min-h-screen overflow-hidden bg-[#12180f] text-[#e3e7e3]`}
    >
      {/* =====================================================
          BACKGROUND
          (removed the glowing orb blurs — kept a simple,
          quiet vignette instead of a lit "energy source" feel)
      ====================================================== */}
      <div className="pointer-events-none fixed inset-0 -z-0 overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-[#182617]/70" />
        <div className="absolute inset-0 bg-[linear-gradient(to_bottom,rgba(10,15,10,0.4)_0%,rgba(18,24,15,0.1)_35%,rgba(10,15,10,0.65)_100%)]" />
      </div>

      {/* =====================================================
          HEADER
      ====================================================== */}
      <header className="relative z-20 flex items-center justify-between border-b border-white/5 bg-[#12180f]/40 px-6 py-7 md:px-14">
        <a
          href="/"
        ...
        <a
          href="/"
          className="rounded-full border border-white/10 bg-white/5 px-5 py-2.5 text-[10px] font-semibold uppercase tracking-[0.18em] text-white/80 transition-all hover:bg-white/10 hover:text-white"
        >
          Back to Home
        </a>
      </header>
      ...
      <section className="relative z-10 px-6 pb-24 pt-16 md:px-14 md:pb-32 md:pt-24">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-8 max-w-xl text-sm leading-relaxed text-[#a1aca3] md:text-base">
          ...
          <div className="mt-12 flex justify-center">
            <div className="inline-flex items-center rounded-full border border-[#344438] bg-[#141c12] p-1.5 shadow-[0_10px_30px_rgba(0,0,0,0.25)]">
              <button
                onClick={() => setActive("garden")}
                className={`relative rounded-full px-8 py-3.5 text-[10px] font-semibold uppercase tracking-[0.22em] transition-all duration-300 ${
                  active === "garden"
                    ? "bg-[#e4e9e4] text-[#101610] shadow-md"
                    : "text-[#879388] hover:text-white"
                }`}
              >
                🌿 Garden Care
              </button>
          ...
          <div className="mt-16">
            {active === "garden" ? (
              <div className="space-y-16">
                {/* Intro Overview Card */}
                <div className="rounded-3xl border border-[#344438] bg-[#141c12] p-8 shadow-[0_20px_60px_rgba(0,0,0,0.18)] md:p-12">
                  <div className="max-w-3xl">
                    ...
                    <p className="mt-4 text-sm leading-relaxed text-[#a1aca3] md:text-base">
                ...
                <div className="grid grid-cols-1 gap-8 items-center md:grid-cols-12 md:gap-12">
                  <div className="relative overflow-hidden rounded-3xl border border-[#344438] bg-[#141c12] p-3 md:col-span-6 shadow-xl">
                    <div className="relative h-72 w-full overflow-hidden rounded-2xl md:h-[420px]">
                      <img
                        src="/garden-lawn.jpg"
                        alt="Manicured lawn care and precision edging"
                        className="h-full w-full object-cover transition-transform duration-700 hover:scale-105"
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-[#0e1310]/80 via-transparent to-transparent" />
                      <span className="absolute bottom-4 left-4 rounded-full border border-white/10 bg-black/40 px-3.5 py-1.5 text-[9px] font-semibold uppercase tracking-widest text-white/90">
                        Lawn Care
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col justify-center md:col-span-6 md:pl-4">
                    ...
                    <h3
                      className={`${cormorant.className} mt-2 text-3xl font-semibold leading-tight text-white md:text-4xl`}
                    >
                      Healthy, Green Lawns
                    </h3>
                    <p className="mt-4 text-sm leading-relaxed text-[#a1aca3]">
                    ...
                    <ul className="mt-6 space-y-3 border-t border-[#29382d] pt-6">
                      <li className="flex items-start gap-3 text-xs text-[#879388]">
                        <Bullet />
                        <span>
                ...
                <div className="grid grid-cols-1 gap-8 items-center md:grid-cols-12 md:gap-12">
                  ...
                  <div className="order-1 relative overflow-hidden rounded-3xl border border-[#344438] bg-[#141c12] p-3 md:order-2 md:col-span-6 shadow-xl">
                    <div className="relative h-72 w-full overflow-hidden rounded-2xl md:h-[420px]">
                      <img
          ...
          {/* Bottom Info Banner */}
          <div className="mt-16 rounded-3xl border border-[#29382d] bg-[#0f150d] px-7 py-6 shadow-[0_15px_40px_rgba(0,0,0,0.12)] md:px-10">
